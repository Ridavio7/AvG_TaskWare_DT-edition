  ...
  const basePlugins = [
    ...
    new CopyWebpackPlugin({
      patterns: [
        ...
        { from: "src/blocks/button/__control/img/cube.svg", to: "assets/images/" },
        { from: "src/blocks/button/__control/img/delta.svg", to: "assets/images/" },
        { from: "src/blocks/button/__control/img/exclamation_mark.svg", to: "assets/images/" },
