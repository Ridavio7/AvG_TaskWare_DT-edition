...
function addGrfShipSetsRow(num, msum, rsum, uinSet, nameSet, del, uin, tb_id,
    ...
    let cellM1   = newRow.insertCell(2);  cellM1.classList = "td td_odd-column-active";
    let cellR1   = newRow.insertCell(3);  cellR1.classList = "td td_odd-column-active";
    let cellM2   = newRow.insertCell(4);  cellM2.classList = "td td_even-column-active";
    let cellR2   = newRow.insertCell(5);  cellR2.classList = "td td_even-column-active";
    let cellM3   = newRow.insertCell(6);  cellM3.classList = "td td_odd-column-active";
    let cellR3   = newRow.insertCell(7);  cellR3.classList = "td td_odd-column-active";
    let cellM4   = newRow.insertCell(8);  cellM4.classList = "td td_even-column-active";
    let cellR4   = newRow.insertCell(9);  cellR4.classList = "td td_even-column-active";
    let cellM5   = newRow.insertCell(10); cellM5.classList = "td td_odd-column-active";
    let cellR5   = newRow.insertCell(11); cellR5.classList = "td td_odd-column-active";
    let cellM6   = newRow.insertCell(12); cellM6.classList = "td td_even-column-active";
    let cellR6   = newRow.insertCell(13); cellR6.classList = "td td_even-column-active";
    let cellM7   = newRow.insertCell(14); cellM7.classList = "td td_odd-column-active";
    let cellR7   = newRow.insertCell(15); cellR7.classList = "td td_odd-column-active";
    let cellM8   = newRow.insertCell(16); cellM8.classList = "td td_even-column-active";
    let cellR8   = newRow.insertCell(17); cellR8.classList = "td td_even-column-active";
    let cellM9   = newRow.insertCell(18); cellM9.classList = "td td_odd-column-active";
    let cellR9   = newRow.insertCell(19); cellR9.classList = "td td_odd-column-active";
    let cellM10  = newRow.insertCell(20); cellM10.classList = "td td_even-column-active";
    let cellR10  = newRow.insertCell(21); cellR10.classList = "td td_even-column-active"; 
    let cellM11  = newRow.insertCell(22); cellM11.classList = "td td_odd-column-active";
    let cellR11  = newRow.insertCell(23); cellR11.classList = "td td_odd-column-active";
    let cellM12  = newRow.insertCell(24); cellM12.classList = "td td_even-column-active";
    let cellR12  = newRow.insertCell(25); cellR12.classList = "td td_even-column-active";
    let cellMsum = newRow.insertCell(26); cellMsum.classList = "td td_odd-column-active";
    let cellRsum = newRow.insertCell(27); cellRsum.classList = "td td_odd-column-active";
    ...
    cellM1.innerHTML  = `<input class="input__type-text input__type-text_width_100" type="text" value="${m1}"  id="grf_input_m1_${uin}">`;  cellR1.innerHTML  = r1;
    cellM2.innerHTML  = `<input class="input__type-text input__type-text_width_100" type="text" value="${m2}"  id="grf_input_m2_${uin}">`;  cellR2.innerHTML  = r2;
    cellM3.innerHTML  = `<input class="input__type-text input__type-text_width_100" type="text" value="${m3}"  id="grf_input_m3_${uin}">`;  cellR3.innerHTML  = r3;
    cellM4.innerHTML  = `<input class="input__type-text input__type-text_width_100" type="text" value="${m4}"  id="grf_input_m4_${uin}">`;  cellR4.innerHTML  = r4;
    cellM5.innerHTML  = `<input class="input__type-text input__type-text_width_100" type="text" value="${m5}"  id="grf_input_m5_${uin}">`;  cellR5.innerHTML  = r5;
    cellM6.innerHTML  = `<input class="input__type-text input__type-text_width_100" type="text" value="${m6}"  id="grf_input_m6_${uin}">`;  cellR6.innerHTML  = r6;
    cellM7.innerHTML  = `<input class="input__type-text input__type-text_width_100" type="text" value="${m7}"  id="grf_input_m7_${uin}">`;  cellR7.innerHTML  = r7;
    cellM8.innerHTML  = `<input class="input__type-text input__type-text_width_100" type="text" value="${m8}"  id="grf_input_m8_${uin}">`;  cellR8.innerHTML  = r8;
    cellM9.innerHTML  = `<input class="input__type-text input__type-text_width_100" type="text" value="${m9}"  id="grf_input_m9_${uin}">`;  cellR9.innerHTML  = r9;
    cellM10.innerHTML = `<input class="input__type-text input__type-text_width_100" type="text" value="${m10}" id="grf_input_m10_${uin}">`; cellR10.innerHTML = r10;
    cellM11.innerHTML = `<input class="input__type-text input__type-text_width_100" type="text" value="${m11}" id="grf_input_m11_${uin}">`; cellR11.innerHTML = r11;
    cellM12.innerHTML = `<input class="input__type-text input__type-text_width_100" type="text" value="${m12}" id="grf_input_m12_${uin}">`; cellR12.innerHTML = r12;
