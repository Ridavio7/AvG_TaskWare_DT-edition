...
function addGrfShipSetsRow(num, msum, rsum, uinSet, nameSet, del, uin, tb_id,
    ...
    cellM1.innerHTML  = `<input class="input__type-text" type="text" value="${m1}"  id="grf_input_m1_${uin}">`;  cellR1.innerHTML  = r1;
    cellM2.innerHTML  = `<input class="input__type-text" type="text" value="${m2}"  id="grf_input_m2_${uin}">`;  cellR2.innerHTML  = r2;
    cellM3.innerHTML  = `<input class="input__type-text" type="text" value="${m3}"  id="grf_input_m3_${uin}">`;  cellR3.innerHTML  = r3;
    cellM4.innerHTML  = `<input class="input__type-text" type="text" value="${m4}"  id="grf_input_m4_${uin}">`;  cellR4.innerHTML  = r4;
    cellM5.innerHTML  = `<input class="input__type-text" type="text" value="${m5}"  id="grf_input_m5_${uin}">`;  cellR5.innerHTML  = r5;
    cellM6.innerHTML  = `<input class="input__type-text" type="text" value="${m6}"  id="grf_input_m6_${uin}">`;  cellR6.innerHTML  = r6;
    cellM7.innerHTML  = `<input class="input__type-text" type="text" value="${m7}"  id="grf_input_m7_${uin}">`;  cellR7.innerHTML  = r7;
    cellM8.innerHTML  = `<input class="input__type-text" type="text" value="${m8}"  id="grf_input_m8_${uin}">`;  cellR8.innerHTML  = r8;
    cellM9.innerHTML  = `<input class="input__type-text" type="text" value="${m9}"  id="grf_input_m9_${uin}">`;  cellR9.innerHTML  = r9;
    cellM10.innerHTML = `<input class="input__type-text" type="text" value="${m10}" id="grf_input_m10_${uin}">`; cellR10.innerHTML = r10;
    cellM11.innerHTML = `<input class="input__type-text" type="text" value="${m11}" id="grf_input_m11_${uin}">`; cellR11.innerHTML = r11;
    cellM12.innerHTML = `<input class="input__type-text" type="text" value="${m12}" id="grf_input_m12_${uin}">`; cellR12.innerHTML = r12;
