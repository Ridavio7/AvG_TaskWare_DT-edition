...
const funcProcessGetStorages = (result, respobj) => {
    ...
    button_control_mdel.forEach((elem) => {
        elem.addEventListener("click", () => {
            let body  =  {"user":"demo", "meth":"mdel", "obj":"storages", "uin":`${elem.value}`};
    ...
    button_control_update.forEach((elem) => {
        elem.addEventListener("click", () => {
            let body  =  {"user":"demo", "meth":"update", "obj":"storages", "name":"", "uin":`${elem.value}`};
...
const addStoragesRow = (name, del, uin, tb_id) => {
    ...
    cellBtn.innerHTML = `<button class="button__control button__control_update-storages" value="${uin}"><img class="button__control__img" src="assets/images/arrow_3.svg" alt=""></button><button class="button__control button__control_mdel-storages" style="background:${bx_color}" value="${uin}"><img class="button__control__img" src="assets/images/cross.svg"></button>`;
}
