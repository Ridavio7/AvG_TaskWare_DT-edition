import {funcCommand, funcProcessOnlyInfo, clearTable, listenSortSelect, responseProcessor, formatDate} from '../../../js/common/common.js';
...
const addTasksRow = (name, date, status, uin, del, tb_id) => {
    ...
    let cellStatus = newRow.insertCell(1); cellStatus.classList = "td";
