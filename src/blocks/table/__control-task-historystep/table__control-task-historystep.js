...
const addHistorystepRow = (name, datetm, user, count, prim, tb_id) => {
    ...
    let cellDate  = newRow.insertCell(0); cellDate.classList  = "td td__text_align_center"; cellDate.innerHTML = formatDate(datetm, false);
    let cellUser  = newRow.insertCell(1); cellUser.classList  = "td"; cellUser.innerHTML = user;
    let cellName  = newRow.insertCell(2); cellName.classList  = "td"; cellName.innerHTML = name;
    let cellCount = newRow.insertCell(3); cellCount.classList = "td td__text_align_center"; cellCount.innerHTML = count;
    let cellPrim  = newRow.insertCell(4); cellPrim.classList  = "td td_text-wrap"; cellPrim.innerHTML = prim;
}