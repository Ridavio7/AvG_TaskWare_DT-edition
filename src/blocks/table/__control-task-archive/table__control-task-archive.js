...
function buildStructure(data, container) {
    for (const item of data) {
        ...
        for (const task of item.tasks) {
            ...
            tdStatus.innerHTML = `<button class="button__control button__control_action button__control_action_status button__control_modal-tasks-archive-catTask" value="${task.uin}">${setStatus(task.status.uin)}</button>`
