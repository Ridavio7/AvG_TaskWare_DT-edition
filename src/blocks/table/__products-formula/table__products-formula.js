...
const addFormulaProductsRow = (product, uinproduct, compont, uincompont, innprod, uininnprod, count, del, uin, tb_id) => {
    ...
    cellBtn.innerHTML = `<button class="button__control button__control_update-product-formula" value="${uin}"><img class="button__control__img" src="assets/images/arrow_3.svg"></button><button class="button__control button__control_mdel-product-formula" style="background:${bx_color}" value="${uin}"><img class="button__control__img" src="assets/images/cross.svg"></button>`;
}
